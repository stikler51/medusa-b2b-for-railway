          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Section className="my-[32px]">
              ...
              <Text className="text-black text-[14px] leading-[24px]">
                You've been invited to join our platform. Click the button below to accept your invitation and set up
                your account.
              </Text>
            </Section>
            ...
            <Section className="my-[32px]">
              ...
              <Link href={invite_url} className="text-blue-600 no-underline text-[14px] leading-[24px] break-all">
                {invite_url}
              </Link>
            </Section>
...
export const userInvitedEmail = (props: UserInvitedEmailProps) => <UserInvitedEmailComponent {...props} />;
